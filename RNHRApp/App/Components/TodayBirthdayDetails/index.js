...
import { IMG_BDAY } from "../../Assets/images";
...
class TodayBirthdayDetails extends Component {
  ...
  render() {
    // console.log('Props in TodayBirthday', this.props);
    const {
      birthdayArray,
      showWish,
      wishType,
    ...
    // console.log("Birthday wish localStore ....", localStore);
    return (
      <ScrollView
      ...
      >
        <View style={styles.headingContainer}>
          <View style={styles.imgView}>
            <Image style={styles.imgPosition} source={IMG_BDAY} />
            <Text style={styles.textHeader}>
              {getText(I18N_CONSTANTS.WISHES.BIRTHDAY_HEADER)}
            </Text>
          </View>
        </View>
        <ScrollView
        ...
        >
          ...
          {birthdayArray.length > 0 ? (
            <FlatList
              ...
              data={birthdayArray}
              renderItem={this.renderTodayBirthday}
