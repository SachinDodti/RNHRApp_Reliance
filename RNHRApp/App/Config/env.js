const ApplicationConfiguration = {
  ...
  environemnt: "PROD",
  baseUrl: "https://hrconnect.reliancenipponlife.com",
  ...
  appleStoreUrl: `https://hrconnect.reliancenipponlife.com/resource/download.html`,
  banca: "banca",
  ...
  scene: {
    ...
    HR_HELP_DESK: "hrHelpDesk",
    REGISTER_QUERY: "registerQuery",
    TRACK_QUERY: "trackQuery",
    QUERY_SEARCH_DETAILS: "querySearchDetail",
    QUERY_DETAIL_LIST: "queryDetailList",
    VIEW_QUERY_STATUS: "viewQueryStatus",
    PRODUCT_CORNER: "productCorner",
    PRODUCT_CORNER_DETAILS: "productCornerDetails",
    FORCED_NOTIFICATION: "forcedNotification",
  ...
  bypassCandidateEnablement: false,
  iosAllAppOptional: false,
  bypassForceUpgrade: true,
  bypassForcedNotification: false,
  dateFormat: {
